        ...
        for idx, chunk_path in enumerate(temp_chunk_paths):
            ...
            try:
                ...
                if "relations" in data and isinstance(data["relations"], list):
                    ...
                    await send_update(f"Found {len(data['relations'])} relationships...", current_chunk=current_chunk_num, total_chunks=total_chunks)
                    await send_update(f"Generating knowledge Graph...", current_chunk=current_chunk_num, total_chunks=total_chunks)
